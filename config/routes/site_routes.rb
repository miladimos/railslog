module SiteRoutes
  def self.extended(router)
    router.instance_exec do
      ...
      get "categories", to: "site/site#categories", as: :categories
      ...
      get "@:username", to: "site/profile/profile#profile", as: :user_profile
      get "profile/posts/new", to: "site/profile/posts#new"
